...
module.exports = async function handler(req, res) {
  ...
  const { imageBase64, mediaType, isPdf, docType } = req.body || {};
  if (!imageBase64) {
      ...
      body: JSON.stringify({
        ...
        messages: [{
          ...
          content: [
            ...
            {
              type: 'text',
              text: docType === 'vep' ? promptVep : promptComprobante
            }
          ]
        }]
      })
